            ...
            <section className="text-gray-600 body-font h-full pt-10 w-full sponsors">
                ...
                <div className="container px-5 py-8 mx-auto">
                    <div className="flex flex-wrap -m-4">
                        ...
                        <div className="p-4 md:w-1/3 sm:w-full">
                            <div className="flex items-center justify-center h-full">
                                <img className="h-24 w-auto object-center" src="filecoin_white.png" alt="sponsor_logo" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="container px-5 py-8 mx-auto">
                    <div className="flex flex-wrap -m-4">
                        ...
                        <div className="p-4 md:w-1/3 sm:w-full">
                            <div className="flex items-center justify-center h-full">
                                <img className="h-24 w-auto object-center" src="replit_white.png" alt="sponsor_logo" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="container px-5 py-8 mx-auto">
                    <div className="flex flex-wrap -m-4">
                        ...
                        <div className="p-4 md:w-1/3 sm:w-full">
                            <div className="flex items-center justify-center h-full">
                                <img className="h-24 w-auto object-center" src="solana_white.png" alt="sponsor_logo" />
                            </div>
                        </div>
                        <div className="p-4 md:w-1/3 sm:w-full">
                            <div className="flex items-center justify-center h-full">
