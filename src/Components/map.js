...
const MapView = () => {
    ...
    return (
            ...
            <div className="container" style={{ marginTop: "2%", justifyContent: 'center'} }>
            ...
            <iframe
                ...
                width="100%" height="500vh" style={{border: '0', position: 'relative', zIndex: '0' , justifyContent: 'center'}} allowFullScreen="" loading="lazy"
